 ...
 *
 * Main authors: George Paraskevopoulos
 *
...
#ifndef __CROSSSINK_HPP
#define __CROSSINK_HPP

#define COMPONENT_NAME_CROSSINK "cRosSink"
...
class DLLEXPORT cRosSink : public cDataSink {
  ...
  public:
    ...
    SMILECOMPONENT_STATIC_DECL
      cRosSink(const char *_name);
    virtual ~cRosSink();
};


#endif // __CROSSINK_HPP
